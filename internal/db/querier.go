...
type Querier interface {
	...
	DeletePageRendersByPageID(ctx context.Context, pageID int64) error
	...
	GetAllPublishedPageIDs(ctx context.Context, siteID int64) ([]int64, error)
	...
	GetLiveSite(ctx context.Context) (Site, error)
	...
	GetPageRenderByPageAndLocale(ctx context.Context, arg GetPageRenderByPageAndLocaleParams) (PageRender, error)
	...
	GetPublishedPageSlug(ctx context.Context, arg GetPublishedPageSlugParams) (GetPublishedPageSlugRow, error)
	...
	UpsertPageRender(ctx context.Context, arg UpsertPageRenderParams) (PageRender, error)
}
